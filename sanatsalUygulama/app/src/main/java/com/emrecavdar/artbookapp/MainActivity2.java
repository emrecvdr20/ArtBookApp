...
import com.emrecavdar.artbookapp.databinding.ActivityMain2Binding;
...
public class MainActivity2 extends AppCompatActivity {
        ...
        if (info.equals("new")){
            ...
            try {
                ...
                while(cursor.moveToNext()){
                    ...
                    binding.nameText3.setText(cursor.getString(yearIx));
    ...
    public void save(View view){
        ...
        String year = binding.nameText3.getText().toString();
    ...
    public void selectImage(View view){
        ...
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_DENIED){
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)){
                Snackbar.make(view,"Galeriye gitmek için izin lazım",Snackbar.LENGTH_INDEFINITE).setAction("izin ver", new View.OnClickListener() {
                    @Override
        ...
        permissionLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
            ...
            public void onActivityResult(Boolean result) {
                if (result){
                    ...
                    //permission denied
                    Toast.makeText(MainActivity2.this,"İzin lazım",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
